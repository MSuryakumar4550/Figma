...
<section>
  ...
  <h3>📅 Event Details:</h3>
  <ul>
    <li>⏱️ Duration: 24 to 48 hours (Hackathon format)</li>
    ...
    <li>🛠️ Platform: Devpost / Google Forms + GitHub for submissions</li>
  </ul>

  <h3>🛠️ Themes / Tracks:</h3>
  <ol>
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/984d37c5-da7d-408a-8477-05d3784acdc3)
